...
public interface GenericDAOInterface<T, PK extends Serializable>{
	   ...
	   /**
	     ...
	     * @return the list of entities
	     */
	    List<T> findByNamedQuery(final String queryName, int maxResults, Object... params);
	    ...
	    /**
	     * Instantiates a new EntityManager and begins a transaction
	     */
	    void startEntityManager();
	    
	    
	    /**
	     * Commits the active transactions and closes the entity  manager
	     */
